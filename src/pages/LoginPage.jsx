    ...
    <div style={{ minHeight:'100dvh', display:'flex', alignItems:'center', justifyContent:'center', padding:20 }} className="gradient-hero">
      <div className="animate-fade-in-up" style={{ textAlign:'center', maxWidth:420 }}>
        ...
        <h1 style={{ fontSize:'2rem', fontWeight:800, marginBottom:12, lineHeight:1.2 }}>
          Discover Pets <br /><span className="gradient-text">Through Reels</span>
        </h1>
        <p style={{ color:'#94a3b8', fontSize:'1rem', lineHeight:1.6, marginBottom:40 }}>
          Watch adorable pet videos, find your perfect companion, and connect with trusted vendors.
        </p>

        <a href={`${import.meta.env.VITE_API_URL}/auth/google`} className="btn-primary" style={{ padding:'14px 40px', fontSize:'1rem', borderRadius:16, gap:12, width:'100%', justifyContent:'center', textDecoration:'none' }}>
        ...
        <p style={{ marginTop:24, fontSize:'0.75rem', color:'#475569' }}>
